...
public class Inscripcion {
    ...
    public enum EstadoInscripcion {
        INSCRIPTO,    // Alumnos actualmente anotados
        BAJA_100,     // Baja con 100% de reintegro (>= 10 días)
        BAJA_70,      // Baja con 70% de reintegro (1 a 9 días)
        BAJA_50,      // Baja con 50% el mismo día
